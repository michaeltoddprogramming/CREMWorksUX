  ...
  if (showCheckout) {
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-6">
          <Button 
            className="border border-gray-300 text-gray-700 hover:bg-gray-50 mb-4"
              ...
              <CardContent>
                <form onSubmit={handleProcessOrder} className="space-y-4">
                  ...
                  <div className="pt-4">
                    ...
                    >
                      {isProcessing ? 'Processing Order...' : `Place Order - R${(total * 1.15).toFixed(2)}`}
                    </Button>
                  </div>
                </form>
              </CardContent>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <Badge className="bg-gray-200 text-gray-800">{item.category || 'Other'}</Badge>
                      {(item.stock || 0) < 10 && (
                  ...
                  <div className="text-right">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <Button
                        className="border border-gray-300 text-gray-700 hover:bg-gray-50 px-2 py-1"
        ...
        <div className="lg:col-span-1">
          <Card className="sticky top-4">
            ...
            <CardContent>
              ...
              <Button 
                className="border border-gray-300 text-gray-700 hover:bg-gray-50 w-full mt-2" 
                onClick={clearCart}
              >
                Clear Cart
              </Button>
